# Generated by Django 3.0 on 2021-04-02 16:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='category',
            name='cat_name',
            field=models.CharField(choices=[('Science', 'Science'), ('Politics', 'Politics'), ('Technics', 'Technics'), ('History', 'History'), ('Music', 'Music')], max_length=25),
        ),
        migrations.AlterField(
            model_name='comment',
            name='commentator',
